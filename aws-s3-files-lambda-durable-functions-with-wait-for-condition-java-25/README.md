# Amazon S3 Files and AWS Lambda Durable Functions (using wait for condition) with Java SDK
...
AuthorContentExtractor (Durable Lambda)       ← sync steps
    ...
    ├── waitForCondition: upcoming talks approval
...
├── handler/
│   ├── AbstractAuthorContentExtractor.java  # shared steps & wait for condition logic
