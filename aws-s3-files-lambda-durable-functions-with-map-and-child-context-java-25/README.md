# Amazon S3 Files and AWS Lambda Durable Functions (using map and child context) with Java SDK
...
AuthorContentExtractor (Durable Lambda)       ← sync steps
    ...
    ├── map:  saveYouTubeVideosToPlayList (save each YouTube video concurrently) 
...
├── handler/
│   ├── AbstractAuthorContentExtractor.java  # shared steps & common logic
